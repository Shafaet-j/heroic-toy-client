...
const WhatPeopleSay = () => {
  return (
    <section>
      ...
      <div className="carousel container mx-auto" data-aos="flip-down">
        <div id="slide1" className="carousel-item relative w-full">
          <div className=" bg-slate-100 w-full h-96 rounded-2xl flex items-center justify-center flex-col gap-5">
            ...
            <p>I have been able to use eBay Cars to research exactly what car I want, in what trim and average prices for it. It's a great tool to have available to me.</p>
          </div>
